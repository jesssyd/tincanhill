      ...
      <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end">
            <time className="font-mono">10 000 Years Ago</time>
            ...
            with Indigenous cultures migrating to North America. Archaeological
            evidence and oral stories reveal the rich heritage of the Dene
            people in the Yellowknife region.
          </div>
          <hr />
        </li>
        <li>
          ...
          <div className="timeline-end mb-10">
            <time className="font-mono pb-3 ">1934</time>
            <div className="text-lg font-black pb-1 pt-2">
        ...
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end">
            <time className="font-mono pb-3 ">1971</time>
            <div className="text-lg font-black pb-1 pt-2">
        ...
        <li>
          ...
          <div className="timeline-end mb-10">
            <time className="font-mono pb-3 ">1985</time>
            <div className="text-lg font-black pb-1 pt-2">
              City Residential and Mine Exploration Proposals
            </div>
            Between 1985 and 1989, the City proposed residential development on
            Tin Can Hill. Citizen opposition convinced the City to drop its
        ...
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end">
            <time className="font-mono pb-3 ">2000</time>
            <div className="text-lg font-black pb-1 pt-2">
        ...
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end">
            <time className="font-mono pb-3 ">2008</time>
            <div className="text-lg font-black pb-1 pt-2">
              Development Discussions Continue
            </div>
            In 2008-2009, discussions on Tin Can Hill development resumed, with
            concerns about urban sprawl and cost of living motivating supporters
        ...
        <li>
          ...
          <div className="timeline-end mb-10">
            <time className="font-mono pb-3 ">2011</time>
            <div className="text-lg font-black pb-1 pt-2">
              Water Treatment Plant Construction
            </div>
            Federal requirements for a new water treatment plant in Yellowknife
            led to the first significant development on Tin Can Hill. The
            construction, carved into a small portion of the Hill and upgraded
            road access, raising concerns about visual impact and potential
            future development.
          </div>
          <hr />
        </li>
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end">
            <time className="font-mono pb-3 ">2012</time>
            <div className="text-lg font-black pb-1 pt-2">
        ...
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end">
            <time className="font-mono pb-3 ">2023</time>
            <div className="text-lg font-black pb-1 pt-2">
